...
const pageContentService = __importStar(require("../../service/api/pageContentService"));
...
const createPageContent = async (request, response) => {
    try {
...
const updatePageContent = async (request, response) => {
    try {
